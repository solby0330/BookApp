...
class AddCartView: UIView{
  ...
  lazy var collectionView = UICollectionView(frame: .zero, collectionViewLayout: AddCartCollectionViewLayout())
  ...
  func AddCartCollectionViewLayout() -> UICollectionViewLayout {
